...
// BLEClientService        Bleuart_uuid_service(BLEUART_UUID_SERVICE);
// BLEClientCharacteristic Bleuart_uuid_chr_rxd(BLEUART_UUID_CHR_RXD); 
// BLEClientCharacteristic Bleuart_uuid_chr_txd(BLEUART_UUID_CHR_TXD);
